...
/* Skip stubs when upstream CONFIG_QCOM_SCM already provides these symbols */
#if IS_ENABLED(CONFIG_QCOM_KGSL_UPSTREAM) && !IS_ENABLED(CONFIG_QCOM_SCM_ADDON) && !IS_ENABLED(CONFIG_QCOM_SCM)
