#!/usr/bin/env python3
"""Worker 1: 1080p scenarios, all-core + X4-only, 5 repeat runs.
    ...
    for prof in ["422-10", "444-10"]:
        for sc, label in [(False, "all"), (True, "x4")]:
            ...
            for run in range(RUNS):
                headrooms.extend(simulate(1920, 1080, fps, prof, N,
                                          seed=run * 9999, single_core=sc))
            key = f"1080p/{fps}fps/{prof}/{label}"
